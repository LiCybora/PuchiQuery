...
($ => {
  ...
  const COLUMN_DEFAULTS = {
    ...
    //mod
    filterFormatter: undefined,
    sortFormatter: undefined,
  ...
  class BootstrapTable {
        ...
        columns.forEach((column, j) => {
          ...
          if (typeof column.fieldIndex !== 'undefined') {
            ...
            this.header.formatters[column.fieldIndex] = column.formatter
              // MOD!
              this.header.filterFormatters[column.fieldIndex] = column.filterFormatter
              this.header.sortFormatters[column.fieldIndex] = column.sortFormatter

              this.header.dependencies[column.fieldIndex] = column.dependency
      ...
      if (index !== -1) {
        ...
        this.data.sort((a, b) => {
          ...
          if (this.header.dependencies[index] !== undefined) {
              aa = this.header.dependencies[index](aa, a);
              bb = this.header.dependencies[index](bb, b);
          }
          if (this.header.sortFormatters[index] !== undefined) {
              aa = this.header.sortFormatters[index](aa, a);
              bb = this.header.sortFormatters[index](bb, b);
          }
    ...
    initRow (item, i, data) {
      ...
      this.header.fields.forEach((field, j) => {
        ...
        if (this.header.dependencies[j] !== undefined) {
            value_ = this.header.dependencies[j](value_, item);
        }
        value = Utils.calculateObjectValue(column,
